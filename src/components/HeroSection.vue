            ...
            <div class="row">
                ...
                <div class="col-lg-6 pb-4 fade-left" style="border-left: 3px solid rgb(143, 201, 167); letter-spacing: 1px;">
                    ...
                    <div id="animated-text-container">
                        <div id="animated-text" class="mb-2" style="line-height: 40px; font-size: 35px; margin-bottom: -2px; color: rgb(197, 197, 197); font-weight: 600;"></div>                    
                    </div>
                    <div class="mb-3" style="line-height: 45px; font-size: 39px; color: rgb(109, 138, 139); font-weight: 600;">
